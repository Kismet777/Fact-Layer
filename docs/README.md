...
| [`plans/2026-08-12-eval-effectiveness-measurement.md`](plans/2026-08-12-eval-effectiveness-measurement.md) | eval 有效性测量结果层（充实需求树 §5.3） | 🔴 框架已定,待实现 |
...
| eval-L3 | eval 有效性测量结果层（T2 观测 + T3a/T3-turn 因果） | plans/2026-08-12 | 🔴 框架已定,待实现 |
